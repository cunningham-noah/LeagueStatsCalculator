...
Attribute List:
   ...
   armorPerLevel, mr, mrPerLevel, tenacity, moveSpeed, healPower, lifeSteal, lifeOnHit, lethality, armorPen, magicPen, 
   critChance, attackSpeed, attackSpeedPerLevel (Percenergytage), attackDamage, attackDamagePerLevel, 
   abilityPower, CDR, energy, energyRegen, goldCost, goldPerTen, additionalEffects
'''
